...
class Paper {
    ...
    /**
    * Paper factory constructor. This constructor preloads the translation files and appends the main 
    * context to the paper instance for use in the helpers.
    *
    * @param {Object} data - Theme settings (configuration)
    * @param {Object} assembler - Assembler with getTemplates and getTranslations methods.
    *
    */
    static createInstance(data, assembler, callback) {
        let translator;
        ...
        assembler.getTranslations((error, translations) => {
            ...
            const instance = new Paper(data.context.settings, data.context.themeSettings, assembler);
            instance.renderingContext = data.context;
